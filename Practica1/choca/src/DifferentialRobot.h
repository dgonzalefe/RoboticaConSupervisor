...
public:
    ...
    void getBaseState(::RoboCompDifferentialRobot::TBaseState& __p_state)
    {
        getBaseState(__p_state, 0);
    }
    void getBaseState(::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx)
    {
...
public:
    ...
    void end_getBaseState(::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::AsyncResultPtr&);
...
public:
    ...
    void setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state)
    {
        setOdometer(__p_state, 0);
    }
    void setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx)
    {
        setOdometer(__p_state, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setOdometer(__p_state, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setOdometer(__p_state, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_setOdometer(__p_state, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context* __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent);
    
public:
#endif

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state)
    {
        return begin_setOdometer(__p_state, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx)
    {
        return begin_setOdometer(__p_state, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setOdometer(__p_state, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setOdometer(__p_state, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::RoboCompDifferentialRobot::Callback_DifferentialRobot_setOdometerPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setOdometer(__p_state, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setOdometer(const ::RoboCompDifferentialRobot::TBaseState& __p_state, const ::Ice::Context& __ctx, const ::RoboCompDifferentialRobot::Callback_DifferentialRobot_setOdometerPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setOdometer(__p_state, &__ctx, __del, __cookie);
    }
