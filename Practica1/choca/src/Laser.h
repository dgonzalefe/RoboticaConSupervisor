...
public:
    ...
    ::RoboCompLaser::TLaserData getLaserAndBStateData(::RoboCompDifferentialRobot::TBaseState& __p_bState)
    {
        return getLaserAndBStateData(__p_bState, 0);
    }
    ::RoboCompLaser::TLaserData getLaserAndBStateData(::RoboCompDifferentialRobot::TBaseState& __p_bState, const ::Ice::Context& __ctx)
    {
...
public:
    ...
    ::RoboCompLaser::TLaserData end_getLaserAndBStateData(::RoboCompDifferentialRobot::TBaseState& __p_bState, const ::Ice::AsyncResultPtr&);
